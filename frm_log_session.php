...
<input type='hidden' name='mandatory' value='session_id;date;client_id;contract_id;trainer_id;type;comments'>
  <input type="hidden" value="logSession" name="formPurpose" />
  
<div class="entry">
<label class="lbl_regular" style="">
Session id*</label>
<input type="text" size="38" maxlength="15" name="session_id" value="<?= "ses_" . date("Ymd_Hms"); ?>" class="entryField"/> 
</div>
<div class="entry">
<label class="lbl_regular" style="">
Date*</label>
